...
@section('content')
    ...
    <h2>
        ...
        {{ Form::open(array('url' =>  $_ENV['URL'] . '/admin/users/' . $user->id, 'class' => 'form-horizontal', 'id' => 'useredit-form', 'role' => 'form', 'method' => 'put')) }}

        <div class="form-group">
          {{ Form::label('username', 'Username', array('class' => 'col-sm-3 control-label')) }}

          <div class="col-sm-5">
            {{ Form::text('username', $user->username, array('class' => 'form-control', 'id' => 'role-name', 'placeholder' => 'Username')) }}
          </div>
        </div>
